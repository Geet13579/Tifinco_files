...
render() {
  ...
  const changedialogwidth = ((this.state.width)*80)/100;

  const changeinputwidth = changedialogwidth*80/1000*10;
...
<div className='mobile-bar' >
     ...
     <Dialog className='dialogconatiner' open={this.state.open}  fullScreen PaperProps={{
        ...
        <li  style={{    marginBottom: "30px"}}><a href='#Corporate' onClick={this.onconfirmclick} style={{color:"white",font:"normal normal 600 18px Poppins"}}>Corporate Orders</a></li>
      ...
      >
       ...
       <Button className="closebtn" sx={{ height: 40 ,color:"#da2850"}} onClick={this.handleClose}>
        ...
        <DialogTitle style={{color: '#00000',font:" normal normal 400 12px Poppins",with:"100%"}}><strong  >Choose between multiple plan option to according to your preferences</strong></DialogTitle>
        <form  >
        <table class="table">
        <div className='mobilemaintabluardiv'>
        <div className='mobilecolm1'>

        <ul class="molisttable1" >
            <li class="molitable1">Plan</li>
            <li class="molitable12" >3 - 4 Roti</li>
            <li class="molitable12" >Veg-1 / Nonveg-1 / Both</li>
            <li class="molitable12" >Veg-2 / Nonveg-2 / Both</li>
            <li class="molitable12" >Veg-3</li>
            <li class="molitable12" >Salad / Papad / Acchar</li>
            <li class="molitable12" >Sweet Dish</li>
            <li class="molitable12" >Cold Drink</li>
            <li class="molitable1" style={{paddingTop:"49px"}} >Select Plan</li>
          </ul>

        </div>
       
        <div className='mobilecolm2'>

        <ul class="molisttable2">
            <li class="molitable2" style={{backgroundColor:this.state.changelitextclr1,borderTopLeftRadius:"10px",borderTopRightRadius:"10px",color:this.state.changetxthead1,paddingTop:"9px"}}>Eco</li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CheckIcon/></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CheckIcon/></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CloseIcon /></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CloseIcon /></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CheckIcon/></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding}}><CheckIcon/></li>
            <li class="molitable" style={{backgroundColor:this.state.changelitextclr1,color:this.state.changeiconclor1,padding:changepadding,borderBottomLeftRadius:"10px",borderBottomRightRadius:"10px"}}><CloseIcon /></li>
            <li style={{paddingTop:"5px",listStyle:"none"}}>
             <FormControl style={{width:"90%"}}>
               ...
               <div style={{width:"auto",height:"80px",backgroundColor:this.state.divbackcolor1,borderRadius:"10px",border:this.state.bordercolor1,display:"flex",justifyContent:"center",flexDirection:"column"}}>
                <li className='mochangerediotext1' style={{color:this.state.textcolor11}}>Eco</li>
                <li  className='mochangerediotext2' style={{color:this.state.textcolor11}}>&#x20b9; 120</li>
                <li  className='mochangerediotext3' style={{color:this.state.textcolor11}}>Per person</li>
        ...
        <div className='mobilecolm3'>

        <ul class="molisttable3">
            <li class="molitable2" style={{backgroundColor:this.state.changelitextclr2,borderTopLeftRadius:"10px",borderTopRightRadius:"10px",color:this.state.changetxthead2,paddingTop:"9px"}} >Executive</li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CloseIcon /></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr2,color:this.state.changeiconclor2,padding:changepadding, borderBottomLeftRadius:"10px",borderBottomRightRadius:"10px"}} ><CloseIcon /></li>
            <li style={{paddingTop:"5px",listStyle:"none"}}>
             <FormControl style={{width:"90%"}}>
               ...
               <div style={{width:"auto",height:"80px",backgroundColor:this.state.divbackcolor2,borderRadius:"10px",border:this.state.bordercolor2,display:"flex",justifyContent:"center",flexDirection:"column"}}>
                <li className='mochangerediotext1' style={{color:this.state.textcolor21}}>Executive</li>
                <li className='mochangerediotext2' style={{color:this.state.textcolor21}}>&#x20b9; 150</li>
                <li className='mochangerediotext3' style={{color:this.state.textcolor21}}>Per person</li>
        ...
        <div className='mobilecolm4'>



        <ul class="molisttable4">
          <li class="molitable2" style={{backgroundColor:this.state.changelitextclr3,borderTopLeftRadius:"10px",borderTopRightRadius:"10px",color:this.state.changetxthead3,paddingTop:"9px"}}>Premium</li>
          <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding}} ><CheckIcon/></li>
            <li class="molitable" style={{textAlign:"center",backgroundColor:this.state.changelitextclr3,color:this.state.changeiconclor3,padding:changepadding,borderBottomLeftRadius:"10px",borderBottomRightRadius:"10px"}} ><CheckIcon/></li>
            <li style={{paddingTop:"5px",listStyle:"none"}}>
             <FormControl style={{width:"90%"}}>
               ...
               <div style={{width:"auto",height:"80px",backgroundColor:this.state.divbackcolor3,borderRadius:"10px",border:this.state.bordercolor3,display:"flex",justifyContent:"center",flexDirection:"column"}}>
                <li className='mochangerediotext1' style={{color:this.state.textcolor31}}>Premium</li>
                <li className='mochangerediotext2' style={{color:this.state.textcolor31}}>&#x20b9; 210</li>
                <li className='mochangerediotext3' style={{color:this.state.textcolor31}}>Per person</li>
...
<Dialog maxWidth={500} open={this.state.openproceed} PaperProps={{ sx: { width: changedialogwidth, height: "auto",bgcolor:'white',borderRadius:"10px" } }} actions={[
      ...
      <div class="mb-3">
       ...
       <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <div class="input-group" style={{justifyContent:"center"}}>
        <button type="submit" form='sendinfo'  onClick={() => (this.state.status = 0)} className=" mopaybookbtn">Pay Book for <span style={{color:"white",font:" normal normal 700 14px Poppins"}}>&#x20b9; 500</span></button> 
               
             
          <span class="input-group-glue" style={{width:"30px"}}></span>

          {isNaN(totalAmount)?  <button type="submit"  form='sendinfo'  onClick={() => (this.state.status = 1)} className=" mopaybookbtn">Pay Full for <span style={{color:"white",font:" normal normal 700 14px Poppins"}}>&#x20b9; 0</span></button> 
         
         :   <button type="submit"  form='sendinfo'  onClick={() => (this.state.status = 1,this.state.totalAmount=totalAmount)} className=" mopaybookbtn">Pay Full for  <span style={{color:"white",font:" normal normal 700 14px Poppins"}}> &#x20b9; {parseInt(totalAmount)}</span> </button> }
      ...
      <Box zIndex={-100}  sx={{position: 'absolute' ,overflow:"hidden",width:"100%"}} >
                  ...
                  alignItems:"center",
                       ...
                       <div className='mobileflexanimation'>
                    <Typewriter 
                                   options={{
                                    ...
                                    loop: true,
                                      ...
                                      onInit={(typewriter) => {
                                        ...
                                        .typeString('<h1 style="color: #DC2D55; font: normal normal 800 25px Poppins";>An all new way of</h1>')
                                        .pauseFor(300)
                                        
                                        .typeString('<h1 style="color:#141923 ;font:normal normal 800 25px Poppins";>tiffin delivery </h1>')
                                        .typeString('<h1 style="color:#DC2D55;font: normal normal 800 25px Poppins";>and more…<span style="color:black">|</span></h1>')
                                        .pauseFor(300)
                                        .deleteAll()
                                        .typeString('<h1 style="color:#DC2D55;font:normal normal 800 25px Poppins";>Reimagined avatar<h1>')
                                        .typeString('<h1 style="color:#DC2D55;font:normal normal 800 25px Poppins";> of <span style="color:#141923 ;font: normal normal 800 25px Poppins";>combos</span> with chef<h1>')
                                        .typeString('<h1 style="color:#DC2D55;font:normal normal 800 25px Poppins";>Curated menus.<h1>')
                                        .deleteAll()
                                        .typeString('<h1 style="color: #DC2D55; font:normal normal 800 25px Poppins";>Curated meals that</h1>')
                                        .typeString('<h1 style="color: #DC2D55; font:normal normal 800 25px Poppins";>fits in all pocket</h1>')
                                        .typeString('<h1 style="color:#141923 ;font:normal normal 800 25px Poppins";>coming soon...</h1>')
                                         .start();
                                    ...
                                    />
                                      ...
                                      <div className='mobilepostionfixediv'>
                                      <h3 style={{font:"normal normal 600 15px Poppins"}}>Serving first in  <span style={{font:" normal normal 800 18px Poppins"}}>Raipur</span></h3>
                                                        <h3 style={{font:"normal normal 600 12px Poppins", color:"#535A64",textAlign:"center"}}>Register now to get exclusive discount on all subscription plans</h3>
                                                          <h3 style={{textAlign:"start"}}><a href='https://play.google.com/store/apps/details?id=com.prixso.tifinco' target="_blank" rel="noopener noreferrer"><img  src={GooglePayImg}  height={30}></img></a></h3>
            ...
            <Container justifyContent="center" maxWidth={false} sx={{ width:"auto",bgcolor:"#1F1221",borderRadius:"5px",height:"auto"}} >


                <div style={{paddingLeft:"20px",paddingBottom:"25px",paddingTop:"25px"}}>
                <h3 style={{color:"#FFFFFF",font:" normal normal 600 16px Poppins"}}>Enjoy <span style={{color:"#DC2D55",font:" normal normal 600 16px Poppins"}}>pre-planned curated meals</span></h3>
                                  <h3 style={{color:"#FFFFFF",font:" normal normal 600 16px/4px Poppins"}}> delivered at your doorstep</h3>
                                  <h3 style={{color:"#FFFFFF",font:" normal normal 600 16px Poppins"}}> everyday on time</h3>
                                  <h3 style={{color:"#99979C",font:" normal normal 500 14px Poppins",paddingRight:"80px"}}>Plans for all suits starting at 100 per meal</h3>
                                  <div className='mobilebutn' ><span className='mobiletxt'>Explore plans on the app</span></div>
            ...
            <h1 style={{font:"normal normal 600 16px/36px Poppins"}}>Benefits of subscribing to tifinco</h1>


            <Container justifyContent="center" maxWidth={false} sx={{ width:"auto",bgcolor:"#9D95C20D",borderRadius:"5px",height:"285px"}} >
        ...
        <Container justifyContent="center" maxWidth={false} sx={{ width:"auto",bgcolor:"#9D95C20D",borderRadius:"5px",height:"285px",marginTop:"20px"}} >
        ...
        <img  src={Group4} height={70} />
            ...
            <Container   maxWidth={false} sx={{ marginLeft:"auto",marginRight:"auto",width:"100%",justifyContent:"center",marginTop:"30px",marginBottom:"30px"  ,backgroundColor:"#B2AFFF1A"}}>


                    
                 {/*  <div style={{textAlign:"center"}}> 
                   <h5 style={{font:"normal normal 600 10px poppins",color:"#215ACE"}}>Pre-book  
        ...
        <Container sx={{background: "linear-gradient(180deg, #FFE5EB 0%, #FFF3F3 100%)" }}> 
         {/* <div className='gradientdiv'>
            <h1 style={{color:"#141923",font:"normal normal bold 23px/35px Poppins",width:"317px"}}>
            Delicious  <span style={{color:"#DC2D55"}}> Combo Meals</span> you can't resist

            </h1>
            <h1 style={{font:" normal normal 550 16px/22px Poppins",color:"#3D434B",width:"297px"}}>Try our exciting range of veg and non-veg combo meals</h1>
            <h1 style={{font:" normal normal 600 15px/23px Poppins",color:"#FF9E30",width:"223px"}}>Order from our app and get 
            <span style={{color:"#FF8A30",font:"normal normal 600 18px/25px Poppins"}}>&#8377; 50 OFF</span> on your first order</h1>
             <button type="button" className='btn' style={{font:"normal normal 600 14px Poppins",color:"white",backgroundColor:"#DC2D55"}}>ORDER NOW</button> 

            <a href='https://bit.ly/3Pr9XDq' target="_blank" rel="noopener noreferrer"> <button type="button" className='btn' style={{font:"normal normal 600 14px Poppins",color:"white",backgroundColor:"#DC2D55"}}>ORDER NOW ON APP</button></a>


          </div>
          <div className='maincardiv'>

          <div className='cardcontainerhandle1' >
            <div className='cardflex1' style={{backgroundImage:`url(${MaskGroup1})`,backgroundSize:"cover"}} >
            ...
            <div className="cardflex2" style={{backgroundImage:`url(${MaskGroup2})`,backgroundSize:"cover"}}>
          ...
          <div className='textcontainerhandle1' >
          ...
          <div className='cardcontainerhandle2'  >
            <div className='cardflex1' style={{backgroundImage:`url(${MaskGroup3})`,backgroundSize:"cover"}}>



            </div>
            <div className="cardflex2" style={{backgroundImage:`url(${MaskGroup4})`,backgroundSize:"cover"}}>
          ...
          <div className='textcontainerhandle2' >
            <div className='textflex1'  >
              Thali Combos
        ...
        */}  
        ...
        <Container  style={{backgroundColor:"#DA234D",height:"auto",paddingTop:"27px"}} maxWidth={false}>
          <Container style={{height:"auto",paddingLeft:0,paddingRight:0}}>
            ...
            <div className='footercontainerflex'>
                 ...
                 <div className='footercontainerflex1'>
                   <ul style={{ listStyle: "none",color: "#FFFFFF",font:"normal normal 600 18px/37px Poppins",padding:0}}>
...
<button type="button" onClick={()=>this.onconfirmclick1(this.state.planprice) } className="btn  mobileproceedbtn" >Proceed</button> }
                  ...
                  <div className='footercontainerflex2'>
                    <ul style={{ listStyle: "none",color: "#FFFFFF",font:"normal normal 600 18px/43px Poppins"}}>
                      ...
                      <a href="https://www.instagram.com/invites/contact/?i=h3aexg1zjzux&utm_content=p2jfrx0" target="_blank" rel="noopener noreferrer"><img style={{paddingLeft:"20px"}} src={facebook} height={30}/></a></li>
                      ...
                      <div>
                        ...
                        <input onChange={this.handlenewslwtter} type="email" className='form-control' placeholder='Email or Phone No.' style={{height:"40px",width:"70%",marginBottom:"20px",font:" normal normal normal 16px/41px Poppins",color:"black"}} />
                        {this.state.isLoad == true ? <button type='submit' className='btn' style={{height:"auto",width:"auto",borderRadius:"5px",backgroundColor:"#d1d1d1",color:"#a1a1a1",font:" normal normal 600 16px Poppins"}}>Subscribe</button>
                        : <button type='submit' className='btn' style={{height:"auto",width:"auto",borderRadius:"5px",backgroundColor:"#000000",color:"white",font:" normal normal 600 16px Poppins"}}>Subscribe</button>}
        ...
        <div className='endfooterflex' >
                      <div style={{height:"30px"}}></div>
                        <div className='endfooterflex1'>
