...
function Header() {
  ...
  const [users_mgs, setuserData] = useState([]);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const res = await fetch(
        'https://tifinco.com:5000/admin/showusersmgs',{
        method: 'POST',
        headers: {
  ...
  // useEffect(() => {
	   ...
	   // const logout = async () => {
      // const res = await fetch(
        // 'http://tifinco.com:5000/admin/logout',{
        // method: 'POST',
        // headers: {
          // 'Content-Type': 'application/json',
        // },
  ...
  <div className="container">
    <nav className="navbar navbar-light">
      {/* Brand */}
      <a href="/dashboard" className="brand-icon d-flex align-items-center me-3 me-lg-4">
            ...
            <div className="card border-0 w380">
              ...
              <div className="tab-content card-body custom_scroll">
                <div className="tab-pane fade show active" id="Noti-tab-Message" role="tabpanel">
                  ...
                  { !Load ? users_mgs && users_mgs.map(users => (
                    <li className="py-2 mb-1 border-bottom">
                      <a href="javascript:void(0);" className="d-flex">
                        <img className="avatar rounded-circle" src="../../../assets/images/xs/avatar1.jpg" alt />
                        <div className="flex-fill ms-3">
                          <p className="d-flex justify-content-between mb-0 text-muted"><span className="fw-bold">{users.user_name}</span> <small>12min</small></p>
                          <span className="text-muted">{users.subject}<span className="badge bg-success">Review</span></span>
                        </div>
                      </a>
                    </li>
                  ))
        ...
        <div className="card-body p-3 " style={{height:"750px",overflowY:"scroll"}} >
            <ul className="menu-grid list-unstyled row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-1 mb-0">
              ...
              {navbar_toggle =="1"?(      <a  className="d-flex color-700 active" >
                ...
                </a>):(      <a  className="d-flex color-700">
                  <div className="avatar"><i className="fa fa-dashboard" /></div>
                  <div className="flex-fill text-truncate">
                    <p onClick={()=>{setToggle("1")}} className="h6 mb-0">Basic </p>
                    <small className="text-muted">Dashboard</small>
              ...
              <li className="col">
               {navbar_toggle =="2"?(<a  className="d-flex color-700 active ">
              ...
              {navbar_toggle =="3"?(<a  className="d-flex color-700">
                  <div className="avatar"><i className="fa fa-calendar" /></div>
                  <div className="flex-fill text-truncate">
                    <p onClick={()=>{setToggle("3")}} className="h6 mb-0">Website Users</p>
                    <small className="text-muted">Maintain Users Details</small>
                  </div>
                </a>):(<a  className="d-flex color-700">
                  <div className="avatar"><i className="fa fa-calendar" /></div>
          ...
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Admin Dashboard</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              <li><a className="ms-link" href="/dashboard/subscribenow">Subscribe Now </a></li>
                  <li><a className="ms-link" href="/dashboard/corporate_order">Corporate Order</a></li>
                  <li><a className="ms-link" href="/dashboard/Menuofferimage"> Menuoffer Image Order</a></li>
                  <li><a className="ms-link" href="/dashboard/AppbarImage">Appbar Image</a></li>
            </ul>
          </div>
          ...
          <div className="mt-3 border-top pt-2 px-3">
           <h6 className="fw-bold">Create User</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              {/* <li><a className="ms-link" href="/dashboard/contactus">Contact Us </a></li> */}
              {/* <li><Link to="/dashboard/contactus">Create User </Link></li> */}
              
              <li><a className="ms-link" href="/Createuserlogin/Adduser">Add User</a></li>
              <li><a className="ms-link" href="/Createuserlogin/Viewuserlist"> View User List</a></li>
              {/* <li><a className="ms-link" href="/dashboard/subscribenow">Subscribe Now </a></li>
                  <li><a className="ms-link" href="/dashboard/corporate_order">Corporate Order</a></li> */}
            </ul>
          </div>
          ...
          {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/slider/addslider">Manage App Slider </a></h6>
         
          </div>
          }
           {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/slider/offer">Manage  Offer </a></h6>
         
          </div>
          }
           {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/slider/promocode">Promocode</a></h6>
         
          </div>
          }
            {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/slider/orderNow"> Order Now  </a></h6>
...
{/* 
           {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/category/manageCategory">Manage Food Category </a></h6>
        ...
        {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/comboproduct/manage_comboproduct">Manage Food Category</a></h6>
            ...
            {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/customer/manageuserextrafood">Manage User Extra Food  </a></h6>
              ...
              {/* {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">CreateUser Registration </h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/product/insert">Add</a></li>
              <li><a className="ms-link" href="/product/show">View</a></li>
              <li><a className="ms-link" href="/product/update">Update</a></li>  
      ...
      {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold"> Combo Product</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/comboproduct/add_comboproduct">Add</a></li>
              <li><a className="ms-link" href="/comboproduct/Show_comboProd">View</a></li>
      ...
      {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            ...
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/foodplan/insert">Add</a></li>
              <li><a className="ms-link" href="/foodplan/show">View</a></li>
              <li><a className="ms-link" href="/foodplan/addplandays">Manage Plan Days</a></li>
              <li><a className="ms-link" href="/foodplan/updatePlan_img">Subscribed Plan BG Image</a></li>
   ...
   {/*for user */}
          ...
          <div className="mt-3 border-top pt-2 px-3">
            ...
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              <li><a className="ms-link" href="/customer/viewuser">User View </a></li>
        ...
        {navbar_toggle =="2" &&     
          <div className="mt-3 border-top pt-2 px-3">
            ...
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              <li><a className="ms-link" href="/customer/FAQ">Add Faq </a></li>

              <li><a className="ms-link" href="/customer/FAQ_View">View  Faq </a></li>
              {/* <li><a className="ms-link" href="/customer/ActiveUser"> Active user  Plan View </a></li>
              
              <li><a className="ms-link" href="/customer/Expaireuser"> User Expired Plans</a></li> */}
           ...
           {navbar_toggle =="2" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">  Contantcheckbox</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
			

			
              <li><a className="ms-link" href="/customer/contantcheckbox">Add  Contantcheckbox </a></li>

              <li><a className="ms-link" href="/customer/Contantcheckbox_View">View  Contantcheckbox </a></li>
              {/* <li><a className="ms-link" href="/customer/ActiveUser"> Active user  Plan View </a></li>
...
{navbar_toggle =="2" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">User Plan</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
			

			
              <li><a className="ms-link" href="/customer/viewcustomerplan">User Plan View </a></li>
              <li><a className="ms-link" href="/customer/ActiveUser"> Active user  Plan View </a></li>
...
{navbar_toggle =="2" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">  Payment Success Message </h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
			

            <li><a className="ms-link" href="/customer/Staticpaymentsuccessmsg">Staticpaymentsuccessmsg   </a></li> 
              {/* <li><a className="ms-link" href="/customer/Paymentsuccessmsg">Add Payment Sucess Msg </a></li>
             <li><a className="ms-link" href="/customer/ViewPaymentsuccessmsg">ViewPaymentsuccessmsg   </a></li>  */}
           ...
           {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/Privacy_Policy"> Tifinco Privacy Poliocy </a></h6>
            {/* <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/Tifincoprivacypolicy/privacy_policy"> Privacy Poliocy </a></h6>
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/Tifincoprivacypolicy/Return_Refund_Policy"> Return and Refund Policy </a></h6>
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/Tifincoprivacypolicy/EndUser_License_Agreement"> End User License Agreement </a></h6>
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/Tifincoprivacypolicy/Disclaimer"> Disclaimer</a></h6> */}            
          </div>
          }

           {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold"> Tifinco Privacy Policy</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/Tifincoprivacypolicy/privacy_policy"> Privacy Policy </a></li>
              <li><a className="ms-link" href="/Tifincoprivacypolicy/Return_Refund_Policy"> Return and Refund Policy</a></li>
              <li><a className="ms-link" href="/Tifincoprivacypolicy/EndUser_License_Agreement"> End User License Agreement</a></li>
              <li><a className="ms-link" href="/Tifincoprivacypolicy/Disclaimer"> Disclaimer</a></li>
              <li><a className="ms-link" href="/Tifincoprivacypolicy/Cookie_Policy"> Cookie_Policy</a></li>
              <li><a className="ms-link" href="/Tifincoprivacypolicy/Terms_Conditions"> Terms & Conditions</a></li>
         ...
         {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  > Optionals </a></h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
			

			
      <li><a className="ms-link" href="/product/addoptionals">Add</a></li>
      <li><a className="ms-link" href="/product/showoptionalitem"> View </a></li>
       ...
       {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/dashboard/trackdelivery"> Track Delivery Boy</a></h6>
         
          </div>
          }
           {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/dashboard/registerDeliveryBoy">Register Delivery Boy</a></h6>
         
          </div>
          }
             {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/dashboard/TexesandCharges"> Manage Taxes & Charges</a></h6>
         ...
         {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold" > <a  style={{color:"#696969"}}  href="/dashboard/addTiffinPrice"> Manage Tiffin Price</a></h6>
          ...
          <div className="mt-3 border-top pt-2 px-3">
            ...
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              <li><a className="ms-link" href="/customer/prebooklist">Users Pre Book Tiffins List</a></li>
              
              <li><a className="ms-link" href="/customer/ViewUsersComment"> User comments</a></li>
              <li><a className="ms-link" href="/customer/ViewNewsLetter"> News Letter List</a></li>
              ...
              {navbar_toggle =="3" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Manage Website Image</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
                                          
              <li><a className="ms-link" href="/websiteImage/show">Website BackGround Image </a></li>
              {/* <li><a className="ms-link" href="/websiteImage/update">Website BackGround Image  Update</a></li> */}
            </ul>
          </div>
             ...
             {navbar_toggle =="3" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Cororate Orders</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
                                          
              <li><a className="ms-link" href="/customer/Corporate_Order_list">Corporate Order List</a></li>
              {/* <li><a className="ms-link" href="/websiteImage/update">Website BackGround Image  Update</a></li> */}
            </ul>
          </div>
...
{navbar_toggle =="3" &&     
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">User Message</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
			

			
              <li><a className="ms-link" href="/customer/viewuser">View</a></li>
        ...
        <div className="card-footer py-3 px-4">
          <div className="row g-2">
            <div className="col">
              ...
              <span>© <a className="text-primary" target="_blank" href="https://www.tifinco.com/" title="Tifinco">Tifinco</a> All rights reserved.</span>
            </div>
