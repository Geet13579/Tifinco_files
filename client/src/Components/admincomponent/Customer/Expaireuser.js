...
import {GET_CUSTOMER_PLAN_DETAIL,USR_PLAN_FILTER,USER_PLAN_SEARCH,ACTIVEUSER,EXPAIRE } from '../../../Components/admincomponent/links/superadminlinks';


export default class Expaireuser extends Component {
...
<button type="button" className="btn btn-primary" onClick={this.handleSearch}>Search</button>
                      ...
                      <div><br></br></div>
                          ...
                          <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                            <button class="btn btn-danger" type="button" onClick={this.activeUsers} id = "0">Expired Users</button>
                            </div>
                        <div><br></br></div>
            */}
