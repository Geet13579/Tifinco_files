...
// import { FAQINSERT } from '../../../Components/admincomponent/links/superadminlinks';
import {FAQINSERT} from '../../../Components/admincomponent/links/superadminlinks';
...
handleSubmit = event =>  {
 ...
 try{
  axios.post(FAQINSERT, auth, {userid: sessionStorage.getItem('userid')},{
          ...
          <div className="body-header d-flex text-light border-top py-3">
            ...
            <div className="container">
              ...
              <div className="row align-items-center">
                <div className="col-auto">
                  <h1 className="fs-4 mt-1 mb-0">Add  FAQ</h1>
...
<center>
                        <form onSubmit={this.handleSubmit} encType='multipart/form-data'   >
                          ...
                          <div className="col-lg-8">
                            ...
                            <input type="text" className="form-control" name="question" placeholder="Name" onChange={this.Questioninput} required autoComplete='off' />
                          </div>
                          ...
                          <div className="col-lg-8">
                            <lable>  Answer</lable>
                            <textarea rows="5" type="text"  className="form-control" name="answer" placeholder="Answer" onChange={this.Answerinput} required autoComplete='off' ></textarea>
