...
<b><label>Customer Name</label></b>  : &nbsp;&nbsp;{plan.name}<div><br></br></div>
...
<div className="col-lg-12">
<b><label>Meal Days [Duration]</label></b>  : &nbsp;&nbsp;{plan.plan_days} Days<div><br></br></div>
...
Sunday:  {data.sun =="1"?("Yes"):("No")}<br></br> */}


Monday :{plan.repeat_on.m=="1"?"yes":"no"}<br></br>
Tuesday :{plan.repeat_on.t=="1"?"yes":"no"}<br></br>
