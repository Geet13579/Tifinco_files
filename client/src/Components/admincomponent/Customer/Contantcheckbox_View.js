...
import {CONTANTCHECKBOXLIST,CONTANTCHECKBOXDELETE,CONTANTCHECKBOXSEARCH,} from '../../../Components/admincomponent/links/superadminlinks';
...
export class Menulist extends Component {
  ...
  makeHttpRequest = async() => {
    let res = await axios.post(CONTANTCHECKBOXLIST,{userid: sessionStorage.getItem('userid'),},{ headers:{'Content-Type': 'multipart/formdata','content-Type': 'application/json'},}).catch(err => console.log(err));
...
handleSearch = ()=>{
  ...
  try {
    axios.post(CONTANTCHECKBOXSEARCH, sendId, {
  ...
  handledelete = (_id) => {
    ...
    try {
      axios.post(CONTANTCHECKBOXDELETE, sendId, {
        headers: { 'Content-Type': 'application/json' },
      })
        .then(res => {
          //alert(res.data);
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      <div className="row mb-3">
        <div className="col">
          <ol className="breadcrumb bg-transparent mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page">Contantcheckbox List</li>
          </ol>
        </div>
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0"> Contantcheckbox List</h1>
                  ...
                  <option value="all">All</option>
                      ...
                      <table className="table myDataTable table-hover align-middle mb-0">
                        ...
                        <td>{this.state.i = this.state.i + 1}</td>
                                  ...
                                  <td>{faqlist.singlemeal}</td>

                               <td>{faqlist.corporate}</td>
