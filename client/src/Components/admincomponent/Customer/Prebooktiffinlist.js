...
class PREBOOKLIST extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.post(ShOWUSERSINFO,{userid: sessionStorage.getItem('userid'),},{ headers:{'Content-Type': 'multipart/formdata','content-Type': 'application/json'},})
      .then(res => {
               ...
               try{
                axios.post('https://tifinco.com:5000/admin/getorderNewlink', data,{
                  ...
                  .then(res => {
                        ...
                        handleviewpaymentdetails=(orderid)=>{
                          window.location = '/customer/ViewuserPaymentdetails/'+orderid
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      <div className="row mb-3">
        <div className="col">
          <ol className="breadcrumb bg-transparent mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page">Pre Book List</li>
          </ol>
        </div>
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">Pre Book List</h1>
                             ...
                             <thead align="center">
                              ...
                              {  currentList.map((users,index)=>{
                                    return(
                                        ...
                                        <td scope="row" style={{ verticalAlign: "center" }} >{users.user_name} </td>     
                                        <td scope="row" style={{ verticalAlign: "center" }} >{users.user_email} </td>     
                                        <td scope="row" style={{ verticalAlign: "center" }} >{users.user_number} </td>     
                                        <td scope="row" style={{ verticalAlign: "center" }} >{users.plan_type} </td>
                                        <td scope="row" style={{ verticalAlign: "center" }} >{users.orderAmount} </td>  
                                        ...
                                        <Dialog open={this.state.openpopupforpayment} PaperProps={{ sx: { width: "50%", height: "50%",bgcolor:'#ffff ' } }} actions={[
                                          ...
                                          <td scope="row" style={{ verticalAlign: "middle" }}> <button type="button"  onClick={()=>{this.handleviewpaymentdetails(users.orderId)}}  className="btn btn-primary"><VisibilityIcon sx={{fontSize:20}}/></button>
                                        </td>
