...
export class tifinco_privacy_policy extends Component {
  render() {
    return (
  ...
  <p> Tifinco (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Tifinco.</p>
  <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, Tifinco. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. This Privacy Policy was created with <a href="https://termify.io/" target="_blank">Termify</a>.</p>
  ...
  <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced, are strictly defined as:
    ...
    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to TIFINCO FOODTECH PRIVATE LIMITED, UNIHOMES PARISHAR KRAMANK- 167 BHATAGAON RAIPUR CHHATTIGARH that is responsible for your information under this Privacy Policy.</li>
    ...
    <li>Personnel:&nbsp;refers to those individuals who are employed by Tifinco or are under contract to perform a service on behalf of one of the parties.</li>
    ...
    <li>Website: Tifinco's site, which can be accessed via this URL: https://tifinco.com/</li>
  ...
  <ul><li>Name / Username</li><li>Phone Numbers</li><li>Email Addresses</li><li>Mailing Addresses</li><li>Job Titles</li><li>Billing Addresses</li><li>Debit/credit card numbers</li><li>Age</li><li>Password</li>
  </ul>
  <p>We also collect information from mobile devices for a better user experience, although these features are completely optional:</p><ul><li>Location (GPS): Location data&nbsp;helps to create an accurate representation of your interests, and this can be used to bring more targeted and relevant ads to potential customers.</li><li>Phonebook (Contacts list): Your contacts list allows the website/app to be much more easy to use by the user, since accessing your contacts from the app makes you save tons of time.</li><li>Camera (Pictures): Granting camera&nbsp;permission&nbsp;allows the user to upload any picture straight from the website/app, you can safely deny camera permissions for this website/app.</li><li>Photo Gallery (Pictures): Granting photo gallery access&nbsp;allows the user to upload any picture from their photo gallery, you can safely deny photo gallery access for this website/app.</li>
  </ul>
  ...
  <p />
  <h1>When does Tifinco use end user information from third parties?</h1>
  <p>Tifinco will collect End User Data necessary to provide the Tifinco services to our customers.</p>
  ...
  <h1>When does Tifinco use customer information from third parties?</h1>
  <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Tifinco customer, we receive information from a third party that provides automated fraud detection services to Tifinco. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
  ...
  <p>Tifinco will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
  ...
  <p>The rights you have to request updates or corrections to the information Tifinco collects depend on your relationship with Tifinco. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
  ...
  <h1>Personnel</h1>
  <p>If you are a Tifinco worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
  ...
  <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Tifinco or any of its Corporate Affiliates (as defined herein), or that portion of Tifinco or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
  <h1>Affiliates</h1>
  <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Tifinco, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
  <h1>Governing Law</h1>
  ...
  <p>You acknowledge and agree that Tifinco shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. Tifinco does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
...
export default tifinco_privacy_policy