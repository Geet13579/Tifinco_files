...
export class Cookie_Policy extends Component {
  render() {
    return (
      <div>
  ...
  <ul>
    ...
    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Tifinco, that is responsible for your information under this Cookie Policy.</li>
  ...
  <h1>Introduction</h1>
  <p>This Cookie Policy explains how Tifinco and its affiliates (collectively "Tifinco", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website/app, including without limitation https://tifinco.com/ and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>
  ...
  <h1>What type of cookies does Tifinco use?</h1>
