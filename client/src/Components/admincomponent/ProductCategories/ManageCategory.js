  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">Manage Category</h1>
              ...
              this.state.progress && <h5> {
                ...
                `${this.state.progress}%` :"Photo Uploaded ,Please Wait Almost Done....!"}
                 ...
                 {this.state.invalidImage && <h5 style={{ color: "red" }}  className="error"> {this.state.invalidImage}</h5>}
                  ...
                  <input type="text" className="form-control"   name="cat_name"  placeholder="Category Name" onChange={this.cat_nameinput}  required/>
                </div>
