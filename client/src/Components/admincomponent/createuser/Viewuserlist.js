...
import {VIEWUSERLIST,DELETE} from '../../../Components/admincomponent/links/superadminlinks';
export class Viewuserlist extends Component {
  state = {
  ...
  componentDidMount() {
    axios.post(VIEWUSERLIST,{userid: sessionStorage.getItem('userid'),},{ headers:{'Content-Type': 'multipart/formdata','content-Type': 'application/json'},})
      .then(res => {
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      <div className="row mb-3">
        <div className="col">
          <ol className="breadcrumb bg-transparent mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page"> View User List</li>
          </ol>
        </div>
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">  View User   List</h1>
                        ...
                        <tbody>
                          {
                            this.state.menus
                              .map(menuslist =>
                               ...
                               <td>{menuslist.email}</td>

                               <td>{(menuslist.password)}</td>
                               <td>{menuslist.admintype}</td>
                               <td><img src={menuslist.profileImage} className="form-control form-control-lg" height={"100px"} width={"150px"} alt="corporate image" ></img></td>
                           
                                  
                                  {/* <td>{menuslist.p_menus}</td> */}
