...
import { FETCH_SLIDER,ADD_SLIDER,DELETE_SLIDER,} from '../../../Components/admincomponent/links/superadminlinks';
...
export default class Subscribenow extends Component {
    ...
    handleSubmit = event =>  {
     ...
     try{
        axios.post(ADD_SLIDER, formData , {userid: sessionStorage.getItem('userid')},{
...
handledelete = (_id)=>{
  ...
  try{
    axios.post(DELETE_SLIDER, sendId , {
...
<div className="main px-lg-5 px-md-2">
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">Add Sliders</h1>
              ...
              this.state.progress && <h5> {
                ...
                `${this.state.progress}%` :"Photo Uploaded ,Please Wait Almost Done....!"}
                 ...
                 {this.state.invalidImage && <h5 style={{ color: "red" }}  className="error"> {this.state.invalidImage}</h5>}
                  ...
                  <input type="file" className="form-control"   name="slider_image"  onChange={this.slider_imageinput}  required/>
                </div>
  ...
  {console.log(this.state.i=0)}
    {this.state.preSlider.map(slider_data =>(
    <tr>
      <th scope="row" style={{ verticalAlign: "middle" }} >{this.state.i = this.state.i +1 } </th>

     <td> <img src={slider_data.image}  height={"70px"} width={"70px"} alt="subscribe image"></img></td>

      <td style={{ verticalAlign: "middle" }}>
        
 <button onClick={() => { if(window.confirm('Do you want to delete  image?')){this.handledelete(slider_data._id)}}}type="button" className="btn btn-danger valign-middle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
