            ...
            console.log(json);
             this.setState({
              ...
              fetch(GET_ONE_PRODUCT,{
                 ...
                 foodType:data.p_foodtype.toString(),
                 price:data.p_price,
...
//       }
    ...
    handleSubmit = event =>  {
     ...
     try{
        axios.post(UPDATE_PRODUCT, formData ,{userid:sessionStorage.getItem('userid')}, {
            ...
            <div className="card-body">
              ...
              this.state.progress && <h5> {
                ...
                `${this.state.progress}%` :"Photo Uploaded ,Please Wait Almost Done....!"}
                 ...
                 <label>Food Name</label><div><br></br></div>
