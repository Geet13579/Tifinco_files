...
import {ADD_OPTIONAL_ITEM} from '../../../Components/admincomponent/links/superadminlinks';
    ...
    state = {
      ...
      return this.state.optionals.map((row, i) =>
          <div key={i}>
           ...
           <input type="text" className="form-control"  name="options" placeholder='options'  onChange={this.handleChangeInputForoptions.bind(this, row.id)} required></input><br></br>
           <label> Price {i+1}</label><br></br>
           <input type="text" className="form-control"  name="price" placeholder='price'  onChange={this.handleChangeInputForoptions.bind(this, row.id)} required></input><br></br>
...
try{
  axios.post(ADD_OPTIONAL_ITEM, data , {
...
<br></br>
                        <input type="text" className="form-control"  name="itemheading" placeholder='Title' onChange={this.handleinputtitle} required></input><br></br>
