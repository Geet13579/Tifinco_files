    ...
    <nav className="navbar navbar-light">
      ...
      <div className="card shadow menu slidedown">
        <div className="card-body p-3">
          ...
          {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Tiffin Entry</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/Delivery/addtiffin">Add New Tiffin</a></li>
...
{/* 
       {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">User List</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              
              <li><a className="ms-link" href="/ViewUserList/View_User_List">View</a></li>
      ...
      {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Allocate Tiffin</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              ...
              {/* <li><a className="ms-link" href="">Update</a></li> */}
                ...
                {navbar_toggle =="1" && 
          <div className="mt-3 border-top pt-2 px-3">
            <h6 className="fw-bold">Track User</h6>
            <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/Delivery/trackuser">Track</a></li>
