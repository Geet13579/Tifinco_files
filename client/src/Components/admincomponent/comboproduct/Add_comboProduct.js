...
import {ADD_FOOD, FETCH_FOOD_CAT,INSERTCOMBOPACK,ORDER_FETCH_SLIDER} from '../../../Components/admincomponent/links/superadminlinks';
...
export default class Addfoodproduct extends Component {
    ...
    state = {
     ...
     desc1input = event =>{
      ...
      combo_nameinput = event =>{
        this.setState({ combo_name:event.target.value})
      }
     ...
     tifinco_specialinput = event =>{
      ...
      prod_imginput = event => {
        ...
        this.setState({  prod_image : event.target.files[0]});
      }
    ...
    handleSubmit = event =>  {
        ...
        this.setState({
            ...
            formData.append('p_image', this.state.prod_image);
            formData.append('p_combotype', this.state. prodType);
           
            formData.append('p_name', this.state.combo_name);
           ...
           formData.append('p_description', this.state.final_desc );
            ...
            formData.append('p_foodtype', this.state.prodType);
            
            console.log(formData);
          
     try{
        axios.post(INSERTCOMBOPACK, formData , {userid: sessionStorage.getItem('userid')},{
...
<div className="main px-lg-5 px-md-2">
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      <div className="row mb-3">
        <div className="col">
          <ol className="breadcrumb bg-transparent mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page">Add Combo Product</li>
          </ol>
        </div>
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">Add Combo Product</h1>
          ...
          <div className="card">
            <div className="card-body">
              ...
              this.state.progress && <h5> {
                ...
                <input type="text" className="form-control"   name="combo_name"  placeholder="Combo Product Name" onChange={this.combo_nameinput}  required autoComplete='off'/>
                </div>
  ...
  <div className="form-check-inline">
    <input className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" defaultValue="veg" onChange={this.prodtypeinput}  defaultChecked />
    <label className="form-check-label" htmlFor="exampleRadios1">
    <span>&nbsp;&nbsp;</span>   Veg
    </label>
  </div>
  <div className="form-check-inline">
    <input className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" onChange={this.prodtypeinput}  defaultValue="nonveg" />
...
<select class="form-control" name= "category" onChange = {this.category_nameinput} tabindex="-90" required>
                ...
                <input type="file" className="form-control"   name="prod_image"   onChange={this.prod_imginput}  required/>
                </div>
                <div ><br></br></div>
