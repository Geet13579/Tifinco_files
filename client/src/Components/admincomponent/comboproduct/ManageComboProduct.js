...
import {FETCH_FOOD_CAT, ADD_FOOD_CAT_LINK,DELETE_CAT_FOOD} from '../../../Components/admincomponent/links/superadminlinks';
...
export default class ManageCategory extends Component {
    ...
    handleSubmit = event =>  {
     ...
     try{
        axios.post(ADD_FOOD_CAT_LINK, formData ,{userid: sessionStorage.getItem('userid')}, {
...
handledelete = (_id)=>{
  ...
  try{
    axios.post(DELETE_CAT_FOOD, sendId , {
...
<div className="main px-lg-5 px-md-2">
  ...
  <div className="body-header d-flex text-light border-top py-3">
    ...
    <div className="container">
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <h1 className="fs-4 mt-1 mb-0">Manage ComboProduct Category</h1>
              ...
              this.state.progress && <h5> {
                ...
                `${this.state.progress}%` :"Photo Uploaded ,Please Wait Almost Done....!"}
                 ...
                 {this.state.invalidImage && <h5 style={{ color: "red" }}  className="error"> {this.state.invalidImage}</h5>}
                  ...
                  <input type="text" className="form-control"   name="cat_name"  placeholder="combo prod Category Name" onChange={this.cat_nameinput}  required/>
                </div>
                  
                    <div ><br></br></div>
                    <div className="col-lg-12">
                  <input type="file" className="form-control"   name="category_image"  onChange={this.categoryinput}  required/>
                </div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col"> Combo Product Category Name</th>
  ...
  {console.log(this.state.i=0)}
    ...
    <tr>
     ...
     <td> <img src={cat_data.cat_image}  height={"70px"} width={"70px"} alt="subscribe image"></img></td>
 

      <td style={{ verticalAlign: "middle" }}>
        
 <button onClick={() => { if(window.confirm('Do you want to delete  image?')){this.handledelete(cat_data._id)}}}type="button" className="btn btn-danger valign-middle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
