...
import {MASTERMENU} from '../../../Components/admincomponent/links/Kitchenlinks';

export class KitchenTodaymenu extends Component {
...
try{
  axios.post(MASTERMENU, formData , {
      ...
      <div className="row mb-3">
        <div className="col">
          <ol className="breadcrumb bg-transparent mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page"> Kitchen  Menus</li>
          </ol>
        </div>
          ...
          <div className="card">
            <div className="card-body">
              ...
              this.state.progress && <h5> {
                ...
                <input type="text" className="form-control"   name="p_name"  placeholder="p_name" onChange={this.p_nameinput}  required autoComplete='off'/>
                </div>
...
export default KitchenTodaymenu