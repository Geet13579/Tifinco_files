...
// import {InsertRawmaterial} from '../../../Components/admincomponent/links/Kitchenlinks';
import {ADDROWMATERIAL} from '../../../Components/admincomponent/links/Kitchenlinks';

export class InsertRawmaterial extends Component {
...
handleSubmit = event =>  {
    event.preventDefault();
        ...
        const formData = {
            ...
            p_name:this.state.food_name,
            p_foodtype:this.state.foodType
        }
