...
const K_Header = () => {
    ...
    <div className="container">
      <nav className="navbar navbar-light">
        ...
        <a href="/dashboard" className="brand-icon d-flex align-items-center me-3 me-lg-4">
          ...
          <span className="fs-5 text-primary fw-bold d-none d-md-block">Tifinco/Kitchen Pannel</span>
        </a>
        ...
        <div className="card shadow menu slidedown">
          <div className="card-body p-3">
                ...
                <li className="col">
                  <a  className="d-flex color-700 active">
                    ...
                    <div className="flex-fill text-truncate">
                      ...
                      <small className="text-muted"> Kitchen Dashboard</small>
                    </div>
                  </a>
                </li>
                <li className="col">
            ...
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold">Kitchen  Dashboard</h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              
  
              
                <li><a className="ms-link" href="/KitchenRoutes/Kitchedashboard/K_contactus">Contact Us </a></li>
                <li><a className="ms-link" href="/KitchenRoutes/Kitchedashboard/Dashboard"> Dashboard </a></li>

                {/* <li><a className="ms-link" href="/KitchenRoutes/Kitchedashboard/Userinfo">Userinfo</a></li>
                
                <li><a className="ms-link" href="/Kitchedashboard/K_contactus">Profile</a></li> */}
                {/* <li><a className="ms-link" href="/dashboard/subscribenow">Recent Order </a></li> */}
                  ...
                  {/* {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold">Total Subscription  For  Day </h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
                <li><a className="ms-link" href="/KitchenRoutes/Kitchedashboard/K_Subcribtion">Subscription List</a></li>
            ...
            {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold"> Raw Materials Manager</h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/KitchenRoutes/Rawmaterialroutes/Addrawmaterial"> Add Raw  Materials</a></li>
              <li><a className="ms-link" href="/KitchenRoutes/Rawmaterialroutes/TodayRawmaterial"> Today Menu raw Materials </a></li>
              <li><a className="ms-link" href="/KitchenRoutes/Rawmaterialroutes/viewrawmaterial">Raw  Material List </a></li>
                 {/* <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/RandomNo">    Random Menu Genrator </a></li> */}
  ...
  {/* {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold"> Master unlike Food </h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/AddMasterunlikefood">    Add Master  Menu </a></li>
  ...
  {/* {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold">  Random   menu  genrator </h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/KitchenTodaymenu">    Add Master  Menu </a></li>
              <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/Mastermenuslist">   Master menu List </a></li>
              <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/RandomNo">    Random Menu Genrator </a></li>
            ...
            <div className="mt-3 border-top pt-2 px-3">
              ...
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              {/* <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/KitchenTodaymenu">  Today Kitchen Menu </a></li> */}
    
              {/* <li><a className="ms-link" href="">Add on Meal </a></li> */}
            
                <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/Addmenu"> Add   Menus</a></li>
                <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/Todaymenu">Today Menu </a></li>
           
                <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/Menulist">Menu List</a></li>
                {/* <li><a className="ms-link" href="/KitchenRoutes/Menuroutes/Qrscanner">Qr scanner</a></li> */}
              
                {/* <li><a className="ms-link" href=""> </a></li> */}
         ...
         {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              ...
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              {/* <li><a className="ms-link" href="">Single Meal Order</a></li> */}
              <li><a className="ms-link" href="/KitchenRoutes/Orderroutes/Orderlist">Order List</a></li>
                <li><a className="ms-link" href="/KitchenRoutes/Orderroutes/CurrentOrder"> CurrentOrder</a></li>
                <li><a className="ms-link" href="/KitchenRoutes/Orderroutes/ViewOrder"> order</a></li>
  ...
  {navbar_toggle =="1" && 
            <div className="mt-3 border-top pt-2 px-3">
              <h6 className="fw-bold">Extraitem</h6>
              <ul className="menu-list d-flex flex-wrap list-unstyled mb-0">
              {/* <li><a className="ms-link" href="">Single Meal Order</a></li> */}
              <li><a className="ms-link" href="/KitchenRoutes/Extraitemroutes/Extraitem"> Extraitem</a></li>
