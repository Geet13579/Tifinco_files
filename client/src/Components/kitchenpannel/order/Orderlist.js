...
import { SHOW_ORDER, DELETE_ORDER, FILTERORDER } from '../../../Components/admincomponent/links/Kitchenlinks';
export class Orderlist extends Component {
  ...
  makeHttpRequest = async () => {
    let res = await axios.post(SHOW_ORDER, { userid: sessionStorage.getItem('userid'), }, { headers: { 'Content-Type': 'multipart/formdata', 'content-Type': 'application/json' }, }).catch(err => console.log(err));
...
// console.log(orders.item);
    ...
    //   console.log(d.item)
      ...
      //     // obj.map(orderlist=>
      //     //   console.log(orderlist.name)
      //     //   )
      //   })
    
    //})

    //   this.setState({orders:d.item,
          ...
          <div className="body-header d-flex text-light border-top py-3">
            ...
            <div className="container">
              ...
              <div className="row align-items-center">
                <div className="col-auto">
                  <h1 className="fs-4 mt-1 mb-0">OrderList</h1>
...
{/* 
                                    ...
                                    {/* <td>  <Popup trigger={<button className="btn btn-sm btn-danger"> View </button>}   position="top">
                                      {orderslist.address.split('@').map(function (value, index, array) {
